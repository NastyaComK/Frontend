        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">For clients</a>
                <ul class="dropdown-menu">
            ...
            <ul class="nav-shop">
              ...
              <li class="nav-item"><a class="button button-header" href="/auth">Sign In</a></li>
            </ul>
          </div>
        </div>
      </nav>
